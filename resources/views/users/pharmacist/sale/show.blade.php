                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form id="formSubmit" action="{{ route('pharmacy.payment.pay', $payment->id) }}">
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-info px-4">Valider</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <div class="px-5 bg-color">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label"><b>Motif de la consultation</b></label>
                                        <textarea type="text" rows="1" class="form-control" name="motif_consultation" id="motif_consultation"
                                            value="{{ $payment->hospitalisationDrugRequested->hospitalisation->consultation->admission->motif_consultation }}" readonly>{{ $payment->hospitalisationDrugRequested->hospitalisation->consultation->admission->motif_consultation }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $("#formSubmit").submit(function(e) {
                ...
                Swal.fire({
                    title: 'Voulez vous vraiment valider le paiement?',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#089E4C',
