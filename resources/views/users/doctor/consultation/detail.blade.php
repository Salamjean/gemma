                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-flex no-block fa fa-check-circle text-success">
                                                <h6 class="ms-10 me-10 ml-10 text-dark">{{ $medicament->drugHospital->drug->name }}</h6>
                                            </div>
                                            @else
                                            <div class="d-flex no-block fa fa-check-circle text-success">
                                                <h6 class="ms-10 me-10 ml-10 text-dark">{{ $medicament->drug->name }}</h6>
                                            </div>
                                                
                                            @endif
                                        </td>
                                        <td class="ms-10 me-10 ml-10">{{ $medicament->dosage }}</td>
                                        <td class="ms-10 me-10 ml-10">{{ $medicament->quantity }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        vide...
