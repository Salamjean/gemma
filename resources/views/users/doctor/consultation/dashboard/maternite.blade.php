<div class="container-dashboard">
    <div class="container-consultation">
        <div>
            ...
            @if ($action['bulletin'] == 0)
                ...
                <section class="section-consultation">
                    ...
                    <div class="section-item">
                        <div><a href="{{ route('doctor.consultation.formulaire', ['consultation-pre-natale', $id] ) }}">Consultation pre-natale</a></div>
                    ...
                    <div class="section-item">
                        <div><a href="{{ route('doctor.consultation.formulaire', ['consultation-post-natale', $id] ) }}">Consultation post-natale</a></div>
                        <div class="section-action">
                    ...
                    <div class="section-item">
                        <div><a href="{{ route('doctor.consultation.formulaire', ['accouchement', $id] ) }}">Accouchement</a></div>
                        <div class="section-action">
            ...
            <section class="section-consultation">
                <div class="section-item">
                    <div><a href="{{ route('doctor.consultation.formulaire', ['declaration-naissance', $id] ) }}">Déclaration de naissance</a></div>
                    <div class="section-action">
