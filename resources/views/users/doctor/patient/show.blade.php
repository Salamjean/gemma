@extends('layouts.dashboard', ['title' => 'Détails de declaration n° ' . $patient->code_patient])
                            ...
                            <div class="box-footer" style="padding-top: 100px;">
                                <div class="row">
                                    ...
                                    @if ($patient->nom_personne2_cas_urgence)
                                        <div class="col-sm-6">
                                            <div class="decalration-header">
                                                <div class="declaration-header-title">Personne à contacter en cas d'urgence n°2 :
                                                </div>
                                                <h5 class="declaration-header-description">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="decalration-header">
                                                <div class="declaration-header-title">Numéro personne à contacter en cas d'urgence n°2 :</div>
                                                <h5 class="declaration-header-description">
