...
@section('content')
                                    ...
                                    <div class="div-group" style="margin-top: 30px; margin-left:30px;">
                                        <div class="c-inputs-stacked">
                                            <div style="padding-bottom: 25px">
                                                <input type="checkbox" id="ordonnance_interne" name="postIssue"
                                                    value="ordonnance_interne">
                                                <label class="me-30" style="font-size: 20px;"
                                                    for="ordonnance_interne">Prescrire
                                                    une ordonnance interne</label>
                                            </div>
                                            <div style="padding-bottom: 25px">
                                                <input type="checkbox" id="ordonnance_externe" name="postIssue"
                                                    value="ordonnance_externe">
                                                <label class="me-30" style="font-size: 20px;"
                                                    for="ordonnance_externe">Prescrire
                                                    une ordonnance externe</label>
                                            </div>
    ...
    <div id="sectionPrescription">
        ...
        <div>
            <a href="{{ route('dashboard') }}" class="btn btn-primary btn-submit" style="background-color: rgb(18, 1, 78) margin-left:30px; border:none;">
    ...
    <script>
        (function($) {
            ...
            $('#prescriptionForm').on('submit', function(e) {
                ...
                if (valeurCheck.find(e => e == 'ordonnance_externe'))
                    $("#ordonnanceSection").css("display", "block");

                if (valeurCheck.find(e => e == 'ordonnance_interne'))
