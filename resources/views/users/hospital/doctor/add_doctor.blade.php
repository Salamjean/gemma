<form class="form" action="{{ route('hospital.doctor.storeDoctor') }}" method="post" id="medecin"
    enctype="multipart/form-data">
    @csrf
    <div class="box-body">
        <h4 class="box-title text-success mb-0"><i class="fa-solid fa-user-md"></i> Infos sur le medecin
        </h4>
        <hr class="my-15">
        ...
        <div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="matricule" name="matricule"
                            ...
                            required autocomplete="matricule" autofocus placeholder="Matricule du medecin">
                        @error('matricule')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="address" name="address"
                            ...
                            required autocomplete="address" autofocus placeholder="Lieu d'habitation">
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label for="pservice" class="form-label">Acte medicaux<span
                            class="text-danger fw-bold">*</span></label>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="type_name" class="form-label">Spécialités medicale<span
                                class="text-danger fw-bold">*</span></label>
                        <select class="form-select text-uppercase" id="type_name" name="type_name" required
                            style="width: 100%;">
                            <option value="">----</option>
            ...
            <div class="row">
                <div class="col-md-3 specialiste" id="gynecoContainer">
                    <div class="form-group">
                        <label for="gyneco" class="form-label fw-bold">Etes vous gyneco
                            obstétricien(ne)
                            ? :
                            <span class="danger">*</span></label>
                        <div class="c-inputs-stacked">
                            <input type="radio" id="nonGyneco" value="0" name="gyneco">
                            <label for="nonGyneco" class="me-30">Non</label>
                            <input type="radio" id="ouiGyneco" value="1" name="gyneco">
                            <label for="ouiGyneco" class="me-30">Oui</label>
                        </div>
                    </div>
                </div>

                <div class="col-md-3 specialiste" id="specialiste">
                    <div class="form-group">
                        <label for="type_doctor" class="form-label">A préciser<span
                                class="text-danger fw-bold">*</span></label>
                        <select class="form-select text-uppercase" id="type_doctor" name="type_doctor"
                            style="width: 100%;">
                            <option value="">----</option>
