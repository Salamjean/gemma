                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-end" style="gap: 10px">
                            <a href="{{ route('hospital.type.consultation.index') }}" class="btn btn-primary btn-md shadow">Retour à la liste</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body fs-14">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 py-10">
                            ...
                            <hr class="my-0"><br>
                            <form class="form" action="{{ route('hospital.type.consultation.update', $type->id) }}" method="post" >
                                @csrf
                                @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
