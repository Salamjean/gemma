            ...
            <div class="box">
                <div class="box-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="">
                            <h4 class="box-title">Secretaires</h4>
                        </div>
                        <div class="">
                            <a href="{{ route('hospital.secretariat.add') }}" class="btn btn-success btn-md shadow">Ajouter
                                une secretaire</a>
                        </div>
                    </div>
                </div>
                                ...
                                @forelse($secretariats as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <img src="{{ asset("assets/uploads/secretariat/$item->img_url") }}"
                                                    class="avatar avatar-lg rounded10" alt="Photo de profil" />
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('hospital.secretariat.status', $item->id) }}"
                                            ...
                                            <a href="{{ route('hospital.secretariat.show', $item->id) }}"
                                                class="btn btn-sm btn-success" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title="Modifier"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="{{ route('hospital.secretariat.delete',$item->id) }}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Supprimer"><i class="fa-solid fa-trash"></i></a>
