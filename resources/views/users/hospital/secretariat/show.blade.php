        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-10">
            <div class="box">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-end" style="gap: 10px">
                            <a href="{{ route('hospital.secretariat.index') }}" class="btn btn-primary btn-md shadow">Retour à la liste</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body fs-14">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset("assets/uploads/secretariat/$secretariat->img_url")}}" alt="Image de profil" class="rounded-circle" style="width:150px; heigth:100px">
                        </div>
                        <div class="col-md-9 py-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Matricule :</strong> <span style="color:red;">{{ $secretariat->matricule }}</span></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Nom & Prénom :</strong> {{ $secretariat->user->name }}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Contact :</strong> {{ $secretariat->contact }}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>E-mail :</strong> {{ $secretariat->user->email }}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Adresse :</strong> {{ $secretariat->address }}</div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-label"><strong>Disponibilité :</strong> {{ dayIndexNameString(json_decode($secretariat->user->availability->days)) }}</div>
                                </div>
                            </div>

                            <h4 class="box-title text-success pt-25"><i class="ti-user me-15"></i> Modifier les données </h4>
                            <hr class="my-0">
                            <form class="form pt-20" action="{{ route('hospital.secretariat.update', $secretariat->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $secretariat->user->name }}" required autocomplete="name" autofocus placeholder="Nom et prénoms du docteur">
                                            @error('name')
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="address" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ $secretariat->address }}" required autocomplete="address" autofocus placeholder="Adresse du docteur">
                                                    @error('address')
                                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    @include('users.hospital.planning', ['status' => 'update', 'planning' => $secretariat->user->availability])
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $secretariat->user->email }}" disabled autocomplete="email" placeholder="Adresse email">
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
