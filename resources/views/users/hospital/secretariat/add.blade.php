            ...
            <div class="box">
                <div class="box-header with-border">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            <a href="{{ route('hospital.secretariat.index') }}" class="btn btn-success btn-md shadow">Liste
                                des secretaires</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                <form class="form" action="{{ route('hospital.secretariat.store') }}" method="post"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="matricule" name="matricule"
                                        ...
                                        placeholder="Matricule du secretaire">
                                    @error('matricule')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name"
                                        ...
                                        required autocomplete="name" autofocus placeholder="Nom et prénoms secretaire">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" name="address"
                                        ...
                                        placeholder="Adresse de la secretaire">
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
