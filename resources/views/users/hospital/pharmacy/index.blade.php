            ...
            <div class="box">
                <div class="box-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            <a href="{{ route('hospital.pharmacy.add') }}" class="btn btn-success btn-md shadow">Ajouter une
                                Phamarcie</a>
                        </div>
                    </div>
                </div>
                                ...
                                @forelse($pharmacies as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <img src="{{ asset("assets/uploads/pharmacy/$item->img_url") }}"
                                                    class="avatar avatar-lg rounded10" alt="Photo de profil" />
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($item->user->availability && $item->user->availability->days)
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('hospital.pharmacy.status', $item->id) }}"
                                            ...
                                            <a href="{{ route('hospital.pharmacy.show', $item->id) }}"
                                                class="btn btn-sm btn-success" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title="Modifier"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="{{ route('hospital.pharmacy.delete', $item->id) }}"
