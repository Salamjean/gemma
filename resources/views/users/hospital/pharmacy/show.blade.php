        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-10">
            <div class="box">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-end" style="gap: 10px">
                            <a href="{{ route('hospital.pharmacy.index') }}" class="btn btn-primary btn-md shadow">Retour à la
                                liste</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body fs-14">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset("assets/uploads/pharmacy/$pharmacy->img_url") }}" alt="Image de profil"
                        ...
                        <div class="col-md-9 py-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Matricule :</strong> <span
                                            style="color:red;">{{ $pharmacy->matricule }}</span></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Nom & Prénom :</strong> {{ $pharmacy->user->name }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Contact :</strong> {{ $pharmacy->contact }}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>E-mail :</strong> {{ $pharmacy->user->email }}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label"><strong>Adresse :</strong> {{ $pharmacy->address }}</div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-label"><strong>Disponibilité :</strong> {{ dayIndexNameString(json_decode($pharmacy->user->availability->days)) }}</div>
                                </div>
                            </div>
                            ...
                            <hr class="my-0">
                            <form class="form pt-20" action="{{ route('hospital.pharmacy.update', $pharmacy->id) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name"
                                                ...
                                                value="{{ $pharmacy->user->name }}" required autocomplete="name" autofocus
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address" name="address"
                                                ...
                                                value="{{ $pharmacy->address }}" required autocomplete="address" autofocus
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input type="text" id="contact"
                                                ...
                                                value="{{ $pharmacy->contact }}" required autocomplete="contact" autofocus
                                                placeholder="Contact">
                                        </div>
                                        @error('contact')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                @include('users.hospital.planning', ['status' => 'update', 'planning' => $pharmacy->user->availability])
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" name="email"
                                                ...
                                                value="{{ $pharmacy->user->email }}" disabled autocomplete="email"
