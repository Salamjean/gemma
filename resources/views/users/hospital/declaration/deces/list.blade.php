                                ...
                                @forelse ($declarations as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('hospital.declaration.deces.show', $item->id) }}"
                                                class="btn btn-sm btn-info" title="clique">Voir détails</a>
                                            <a href="{{ route('hospital.declaration.certificat.deces', $item->id) }}" target='_blank' class="btn btn-sm btn-danger" style="cursor: pointer" title="imprimer"><i
