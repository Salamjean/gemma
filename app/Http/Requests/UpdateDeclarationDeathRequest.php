...
class UpdateDeclarationDeathRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            "death_declaration_no" => "required|string|min:9",
            "deceased_personne_fullname" => "required|string|min:3",
            'idcard_no'  => "nullable|string|min:8",
    ...
    public function messages()
    {
        return [
            ...
            "death_declaration_no.required" => "Le N° de la déclqrqtion de décès est requis.",
            "death_declaration_no.string" => "Le N° de la déclqrqtion de décès doit être une chaîne de caractères.",
            "death_declaration_no.min" => "Le N° de la déclqrqtion de décès doit contenir au moins ç caractère.",
